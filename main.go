...
func main() {
	...
	volunteers := r.Group("/volunteer", app.AuthenticationMiddleware("volunteer"))
	{
		...
		volunteers.GET("/participants/search", app.HandleParticipantSearch)
	}
	...
	organiser := r.Group("/organiser", app.AuthenticationMiddleware("organiser"))
	{
		...
		organiser.GET("/participants/search", app.HandleParticipantSearch)
	}
	...
	admin := r.Group("/admin", app.AuthenticationMiddleware("admin"))
	{
		...
		admin.GET("/participants/search", app.HandleParticipantSearch)
	}
